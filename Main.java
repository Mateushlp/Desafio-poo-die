...
devMateus.progredir();
System.out.println("------");
System.out.println("conteudos Concluidos Mateus" + devMateus.getConteudoConcluidos());
System.out.println("XP" + devMateus.calcuarTotalXp());
...
devPaulo.progredir();
System.out.println("------");
System.out.println("Conteudos Concluidos Paulo" + devPaulo.getConteudoConcluidos());
System.out.println("XP" + devPaulo.calcuarTotalXp());
